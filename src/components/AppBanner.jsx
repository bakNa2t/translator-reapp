...
function AppBanner() {
  ...
  return (
    <div className="w-full h-64 bg-gradient-to-r from-[#30cfd0] to-[#330867] dark:bg-gradient-to-r dark:from-[#f9f586] dark:to-[#96fbc4] rounded-t-full rounded-bl-full flex flex-col justify-center text-[#abecd6] dark:text-emerald-600 pr-6 shadow-sd_2">
